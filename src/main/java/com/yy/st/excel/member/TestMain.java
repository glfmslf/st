...
public class TestMain {
    public static void main(String[] args) throws IOException {
        Integer index = 1000;
        String pre = "TN2021395012024051200000";
        userLister userLister = new userLister();
        EasyExcel.read("/Users/yuyou/Desktop/星球会员会员券手动补发.xlsx", UserDto.class, userLister).sheet().doRead();
        ...
        for (UserDto userDto : userLister.getUserDtos()) {
            ...
            String s = "insert into coupon_librarys (name, user_id, channel, order_id, coupon_id, coupon_no, policy, policy_rule, " +
                    ...
                    "channel_type, user_main_id, remark, sale_batch_no, temp_flag) values  ( '5.13会员日赠饮券'," + userDto.getUserId() + ", \'W\', 0, 4279, " +
                    "'TN202139501'," +
                    " " +
                    "'App\\\\Policies\\\\CouponLibrary\\\\FeeCouponPolicy', '{\"valen\":0,\"cup_type\":1,\"cup\":1}', 4279, " +
                    "'App\\\\Models\\\\Coupon', '2024-05-13 00:00:00', '2024-05-31 23:59:59', null, 1, null, 1, \'" + codeId + "\', 0, 0.00, now()," +
                    " now()," +
                    " " +
                    "null, '1', 0, " + userDto.getCardId() + ", null, now(), 'CN', 13,  null, 0, " + userDto.getUserMainId() + ", null, null, 0);\n";
            System.out.print(s);
            fileWriter.write(s );
